<?php
/**
 * Norrböle Sten & Kross AB theme functions.
 *
 * Kept short on purpose. Design lives in theme.json, markup in templates and patterns.
 * Lead capture lives in the "Norrböle Sten & Kross AB Leads" plugin, so leads survive a theme change.
 *
 ...
 * Patterns read these through no_lead() so one demo can be rebuilt for any firm.
 */
...
add_action(
	'wp_enqueue_scripts',
	function () {
		wp_enqueue_style( 'norrbolestenochkross', get_stylesheet_uri(), array(), wp_get_theme()->get( 'Version' ) );
	}
);
add_action(
	'after_setup_theme',
...
add_action(
	'init',
	function () {
		register_block_style( 'core/paragraph', array( 'name' => 'eyebrow', 'label' => __( 'Eyebrow label', 'norrbolestenochkross' ) ) );
		register_block_style( 'core/list', array( 'name' => 'checklist', 'label' => __( 'Tick list', 'norrbolestenochkross' ) ) );

		register_block_pattern_category( 'norrbolestenochkross-sections', array( 'label' => __( 'Norrböle Sten & Kross AB sections', 'norrbolestenochkross' ) ) );
		register_block_pattern_category( 'norrbolestenochkross-pages', array( 'label' => __( 'Norrböle Sten & Kross AB page layouts', 'norrbolestenochkross' ) ) );
	}
);
